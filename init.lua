...
require 'nvim-treesitter.configs'.setup {
    ...
    ensure_installed = { "help", "javascript", "typescript", "c", "lua", "rust", "php", "html" },
...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<space>wa', '<cmd>lua vim.lsp.buf.add_workspace_folder()<CphpR>', opts)
  ...
  buf_set_keymap('i', '<space><CR>', '<cmd>lua vim.lsp.omnifunc()<CR>', opts)
end
